    ...
    <section className="relative flex min-h-[360px] w-full flex-col justify-between gap-6 overflow-hidden border-b border-[#d9b07f]/15 bg-[radial-gradient(circle_at_top_left,_rgba(255,255,255,0.16),_transparent_34%),linear-gradient(135deg,_#4a2b1c_0%,_#6e3d1f_45%,_#c67e3f_100%)] p-6 text-[#fff9f2] sm:p-8 lg:w-1/2 lg:border-b-0 lg:border-r lg:border-[#d9b07f]/15 lg:p-10">
      ...
      <div className="relative z-10">
        ...
        <h1 className="mt-6 text-3xl font-semibold leading-tight sm:text-4xl lg:text-5xl">
          Welcome back to BrewFlow.
        </h1>

        <p className="mt-4 text-sm leading-relaxed text-[#f7e9d8] sm:text-base lg:text-lg">
          Sign in to manage your coffee shop&apos;s menu, inventory, orders, and
        ...
        <div className="relative mt-3 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
          <div>
            ...
            <p className="mt-1 text-[0.85rem] leading-snug text-[#f3e1c6] sm:text-sm">
              Track sales, inventory, and menu performance in real time.
            </p>
          </div>

          <div className="inline-flex shrink-0 items-center justify-center whitespace-nowrap rounded-full bg-[#fff4e8] px-5 py-2 text-sm font-semibold text-[#72391a]">
            Real-Time
          </div>
        </div>
      </div>
